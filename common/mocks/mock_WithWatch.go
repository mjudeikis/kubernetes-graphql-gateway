...
func (_m *MockWithWatch) Apply(ctx context.Context, obj runtime.ApplyConfiguration, opts ...client.ApplyOption) error {
...
func (_c *MockWithWatch_Apply_Call) Return(_a0 error) *MockWithWatch_Apply_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockWithWatch_Apply_Call) RunAndReturn(run func(context.Context, runtime.ApplyConfiguration, ...client.ApplyOption) error) *MockWithWatch_Apply_Call {
	_c.Call.Return(run)
	return _c
}
